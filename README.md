...
[![Tests](https://img.shields.io/badge/tests-417%20passing-brightgreen)](test/)
...
- **Comprehensive Testing** - 417 tests, 93.1% line coverage (api.ts 96.4%, cli-helpers.ts 95.4%, config.ts 94.3%, http.ts 91.2%, utils.ts 89.6%; measured 2026-09-22), no network access; a spec-drift check against the live API runs in CI
